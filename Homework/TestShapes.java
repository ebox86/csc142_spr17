/**
 * This is a simple utility class to test the MyShape hierarchy.
 * 
 * @author Dan Jinguji
 * @version 0.1
 */
public class TestShapes {
	...
	/**
	 * This is the main test method. It will prompt the user for information to
	 * create instances and run use the getArea method.
	 */
	public void test() {
	...
	/**
	 * The application method. This instantiates the class and calls the test
	 * method.
	 *
	 * @param args
